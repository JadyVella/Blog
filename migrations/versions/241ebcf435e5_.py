...
Revision ID: 241ebcf435e5
Revises: 89bf8150ef2f
Create Date: 2020-02-20 15:46:45.791409
...
revision = '241ebcf435e5'
down_revision = '89bf8150ef2f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['post_comments'], ['posts.id'], ),
    sa.ForeignKeyConstraint(['user_comments'], ['users.id'], ),
